...
fn build_tools() -> Vec<Value> {
    vec![
        ...
        tool("semantic_navigation", "LSP navigation and guarded rename plan.", schema(json!({"path":{"type":"string"},"symbol":{"type":"string","minLength":1,"maxLength":300},"line":{"type":"integer","minimum":1},"character":{"type":"integer","minimum":1},"intent":{"type":"string","enum":["inspect","definition","hover","references","incoming_calls","outgoing_calls","calls","implementations","impact","rename_plan"],"default":"inspect"},"max_results":{"type":"integer","minimum":1,"maximum":100,"default":50},"new_name":{"type":"string","minLength":1,"maxLength":300}}), &["path"]), true, false),
